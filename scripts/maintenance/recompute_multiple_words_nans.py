...
Example (from repo root):
  PYTHONPATH=src python scripts/maintenance/recompute_multiple_words_nans.py \\
    --model qwen3-4b --prompt-lang en --list-lang de
  PYTHONPATH=src python scripts/maintenance/recompute_multiple_words_nans.py \\
    --model qwen3-4b --method description --dry-run
"""
...
from lib.direction_ablation import interventions_to_dict, interventions_to_dict_everything_ablation
from lib.intervention import (
    ablation,
    amplification,
    load_nnsight_model,
    normalize_intervention_by_lang,
    normalize_intervention_list,
)
...
def run_debug_probe(
    ...
    from lib.intervention import ablation
