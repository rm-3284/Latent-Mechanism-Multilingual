...
Run on a GPU node:
  cd Latent-Mechanism-Multilingual/src
  python debug_nan_logprobs.py --model qwen3-4b --prompt-lang en --list-lang en
...
def normalize_intervention_list(intervention: list) -> list:
    normalized = []
