...
def _gpu_imports():
    ...
    from ablation_amplification_intervention import model_intervention, model_run
    ...
    from hyperparameter_sensitivity import repo_data_dir as _repo_data_dir
    from intervention import get_best_base
    from interventions_to_json import get_logits_and_ranks
