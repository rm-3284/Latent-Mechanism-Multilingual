...
from lib.ablation_amplification_intervention import ablation_and_amplification, activation_dict
...
from pipeline.multiple_words_intervention import get_logprob_with_intervention
...
def _safe_logprob(
    ...
    try:
        if interventions is None:
            from lib.ablation_amplification_intervention import model_run
