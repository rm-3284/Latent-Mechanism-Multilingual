...
from lib.circuit_tracer_import import Graph, ReplacementModel, attribute, prune_graph
from lib.models import neuronpedia_urls
from lib.template import base_strings, langs, langs_big, identifiers
...
if __name__ == '__main__':
    ...
    data_directory = args.data_dir or os.path.join(data_dir_str(), "flores_features", model)
