...
from lib.template import lang_to_flores_key, langs_big, identifiers
from lib.models import hf_model_names, hf_transcoder_names, neuronpedia_urls, layer_num, n_features
...
if __name__ == "__main__":
    ...
    data_directory = os.path.join(data_dir_str(), "language_specific_features", args.model)
