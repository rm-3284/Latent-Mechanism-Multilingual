...
from lib.circuit_tracer_import import ReplacementModel, attribute
...
if __name__ == "__main__":
    ...
    data_directory = args.output_dir or os.path.join(data_dir_str(), "flores_features", args.model)
