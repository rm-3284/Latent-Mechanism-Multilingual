...
from lib.circuit_tracer_import import attribute, ReplacementModel
from lib.device_setup import device, num_gpus
from lib.template import lang_to_flores_key, identifiers, lang_dict
from lib.models import hf_model_names, hf_transcoder_names, neuronpedia_urls
...
if __name__ == "__main__":
    ...
    data_directory = os.path.join(data_dir_str(), "multilingual_llm_features", args.model)
