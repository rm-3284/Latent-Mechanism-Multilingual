...
from lib.direction_ablation import project_orthogonally
from lib.intervention import get_best_base, get_best_rank, logit_diff_single
...
def default_output_file(model_name: str, prompt_lang: str | None, adj_lang: str | None) -> str:
    from lib.paths import repo_root_str
